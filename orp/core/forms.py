...
class RegulationSearchForm(forms.Form):
    ...
    Regulation search form for searching for regulations by name or description.
    """

    query = forms.CharField(
        required=False,
        label="Enter the sector, business activity or topic you want to find regulations for.",
